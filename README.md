...
## :open_file_folder: Folder contents:
  ...
  2. `csv_parser`: This directory contains Jupyter notebooks for general analysis based on the + scapper and + tut18 datasets. The notebooks are designed to explore the distribution of events across various acoustic scenes.
