...
with h5py.File(filename, "r") as f:
    print("Keys: %s" % f.keys()) # ['audio_name', 'feature', 'identifier', 'scene_label', 'source_label']
    ...
    ds_obj = f[feature]   # returns as a h5py dataset object which contains all 14,400 audio features
