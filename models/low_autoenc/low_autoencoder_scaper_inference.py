...
def main():
    ...
    encoded_feature_dir = Path('/work/aistwal/MMDS_MasterThesis/data/jointSoundScene_data/syntheticSoundscenes/low_autoencoder/encoded_log_mel_features/features')
    decoded_feature_dir = Path('/work/aistwal/MMDS_MasterThesis/data/jointSoundScene_data/syntheticSoundscenes/low_autoencoder/decoded_log_mel_features/features')
...
if __name__=="__main__":
    ...
    # READ PICKLE FILE
    unpickled_encoder_df = pd.read_pickle("data/encoder_data/low_conv_autoencoder_200_50.pkl")
